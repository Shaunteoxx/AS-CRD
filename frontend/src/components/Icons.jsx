...
export const Logo = ({ className }) => (
    ...
    >
        ...
        <path 
            d="M14 11H26V19H20M20 19H26V27H14" 
            stroke="currentColor" 
            strokeWidth="1.5" 
            strokeLinecap="round" 
...
export const AllocateSpaceLogo = ({ className }) => (
    <div className={`flex items-center gap-3 ${className || ''}`}>
        ...
        >
            ...
            <path 
                d="M18 14H30M30 14V22M30 22H22M30 22V30M30 30H18" 
                stroke="currentColor" 
                strokeWidth="1.5" 
                strokeLinecap="round" 
                strokeLinejoin="round"
        ...
        <div className="flex flex-col justify-center h-12">
            <span className="text-lg font-bold tracking-tight leading-none">ALLOCATE</span>
            <span className="text-xs font-medium tracking-[0.2em] leading-none mt-1 opacity-60">SPACE</span>
        </div>
    </div>
);
...
export const LockIcon = ({ className }) => (
    <svg 
        ...
        strokeLinecap="round" 
        strokeLinejoin="round"
        className={`text-brand-main ${className || ''}`}
    >
