    ...
    >
      ...
      >
        <div className="flex items-start justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0">
          <div>
            <span className="inline-block text-xs font-mono font-semibold text-emerald-700 mb-0.5">
              {entry.irdId}
            </span>
            <h2 className="text-base font-semibold text-gray-900">{entry.internalName}</h2>
